...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('recipes_sourcepack', 'recipes_release')

        # Changing field 'PackArg.source_pack'
        db.alter_column('recipes_packarg', 'source_pack_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.Release']))


    def backwards(self, orm):
        db.rename_table('recipes_release','recipes_sourcepack')

        # Changing field 'PackArg.source_pack'
        db.alter_column('recipes_packarg', 'source_pack_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.SourcePack']))
