...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Spec.desc'
        db.add_column('recipes_spec', 'desc', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Spec.desc'
        db.delete_column('recipes_spec', 'desc')
