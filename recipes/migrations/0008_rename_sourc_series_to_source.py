...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming model 'SourceSeries' to 'Source'
        db.rename_table('recipes_sourceseries', 'recipes_source')

        # Changing field 'Release.series'
        db.alter_column('recipes_release', 'series_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.Source']))


    def backwards(self, orm):
        # Renaming model 'Source' to 'SourceSeries'
        db.rename_table('recipes_source', 'recipes_sourceseries')

        # Changing field 'Release.series'
        db.alter_column('recipes_release', 'series_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.SourceSeries']))
