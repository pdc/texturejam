...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DownloadTask.remix'
        db.add_column('recipes_downloadtask', 'remix', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.Remix'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DownloadTask.remix'
        db.delete_column('recipes_downloadtask', 'remix_id')
