...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RecipePack.withdrawn_reason'
        db.add_column('recipes_recipepack', 'withdrawn_reason', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'RecipePack.withdrawn'
        db.add_column('recipes_recipepack', 'withdrawn', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RecipePack.withdrawn_reason'
        db.delete_column('recipes_recipepack', 'withdrawn_reason')

        # Deleting field 'RecipePack.withdrawn'
        db.delete_column('recipes_recipepack', 'withdrawn')
    ...
    models = {
        ...
        'recipes.recipepack': {
            ...
            'withdrawn_reason': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'})
        },
        'recipes.sourcepack': {
