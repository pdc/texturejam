...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DownloadTask'
        db.create_table('recipes_downloadtask', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.Spec'])),
            ('level', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.Level'])),
            ...
            ('problem', self.gf('django.db.models.fields.CharField')(max_length=1000, blank=True)),
        ))
        db.send_create_signal('recipes', ['DownloadTask'])


    def backwards(self, orm):
        
        # Deleting model 'DownloadTask'
        db.delete_table('recipes_downloadtask')
