...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming model 'RecipePack' to 'Remix'
        db.rename_table('recipes_recipepack', 'recipes_remix')

        # Changing field 'PackArg.recipe_pack'
        db.alter_column('recipes_packarg', 'recipe_pack_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.Remix']))


    def backwards(self, orm):
        # Renaming model 'Remix' to 'RecipePack'
        db.rename_table('recipes_remix', 'recipes_recipepack')

        # Changing field 'PackArg.recipe_pack'
        db.alter_column('recipes_packarg', 'recipe_pack_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.RecipePack']))
