...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Remix.queued'
        db.add_column('recipes_remix', 'queued', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Remix.queued'
        db.delete_column('recipes_remix', 'queued')
