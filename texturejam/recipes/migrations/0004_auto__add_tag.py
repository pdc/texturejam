...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field tags on 'Spec'
        db.create_table('recipes_spec_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('spec', models.ForeignKey(orm['recipes.spec'], null=False)),
            ('tag', models.ForeignKey(orm['recipes.tag'], null=False))
        ))
        db.create_unique('recipes_spec_tags', ['spec_id', 'tag_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field tags on 'Spec'
        db.delete_table('recipes_spec_tags')
