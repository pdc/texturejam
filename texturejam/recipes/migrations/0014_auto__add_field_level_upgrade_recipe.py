...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Level.upgrade_recipe'
        db.add_column('recipes_level', 'upgrade_recipe', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['recipes.Spec'], unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Level.upgrade_recipe'
        db.delete_column('recipes_level', 'upgrade_recipe_id')
