...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Person'
        db.create_table('recipes_person', (
        ...
        db.send_create_signal('recipes', ['Person'])

        # Adding M2M table for field artists on 'Source'
        db.create_table('recipes_source_artists', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('source', models.ForeignKey(orm['recipes.source'], null=False)),
            ('person', models.ForeignKey(orm['recipes.person'], null=False))
        ))
        db.create_unique('recipes_source_artists', ['source_id', 'person_id'])


    def backwards(self, orm):
        
        # Deleting model 'Person'
        db.delete_table('recipes_person')

        # Removing M2M table for field artists on 'Source'
        db.delete_table('recipes_source_artists')
    ...
    models = {
        ...
        'recipes.level': {
            ...
            'upgrade_recipe': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['recipes.Spec']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        'recipes.packarg': {
        ...
        'recipes.remix': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'queued': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'recipes.source': {
            ...
            'artists': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['recipes.Person']", 'symmetrical': 'False', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'forum_url': ('django.db.models.fields.URLField', [], {'max_length': '255', 'blank': 'True'}),
            'home_url': ('django.db.models.fields.URLField', [], {'max_length': '255', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
