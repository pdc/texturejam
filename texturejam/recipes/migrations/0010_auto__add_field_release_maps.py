...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Release.maps'
        db.add_column('recipes_release', 'maps', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.Spec'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Release.maps'
        db.delete_column('recipes_release', 'maps_id')
